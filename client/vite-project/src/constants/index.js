//this is the array of all the random prompts that the user can use when user clicks on the surprise-me button 
//to generate the random images from random prompts using this array :-
